...
Java_com_dashcam_lowlatency_NativeFFmpegPlayer_nativeTest(
    JNIEnv* env,
    jobject /* this */) {
...
Java_com_dashcam_lowlatency_NativeFFmpegPlayer_nativeCreate(
    JNIEnv* env,
    jobject /* this */,
    jobject surface) {
...
Java_com_dashcam_lowlatency_NativeFFmpegPlayer_nativeConnect(
    JNIEnv* env,
    jobject /* this */,
    jlong player_ptr,
    jstring rtsp_url) {
...
Java_com_dashcam_lowlatency_NativeFFmpegPlayer_nativeStart(
    JNIEnv* env,
    jobject /* this */,
    jlong player_ptr) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_dashcam_lowlatency_NativeFFmpegPlayer_nativeStop(
    JNIEnv* env,
    jobject /* this */,
    jlong player_ptr) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_dashcam_lowlatency_NativeFFmpegPlayer_nativeRelease(
    JNIEnv* env,
    jobject /* this */,
    jlong player_ptr) {
